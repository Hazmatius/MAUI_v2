...
function [pesos, alpha, beta] = GMMestimator(y,nl,maxIter,index,tol_error,flag_pinta,pesos_inicial,alpha_inicial,beta_inicial)
...
[N,X] = hist(y,linspace(min(y(:)),max(y(:)),150));
